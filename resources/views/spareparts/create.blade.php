...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            <h2 class="text-3xl font-bold font-display text-slate-800 tracking-tight">Tambah Sparepart</h2>
            <p class="text-slate-500 text-sm mt-1 font-medium">Masukkan detail barang baru untuk inventarisasi.</p>
        </div>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="part_number" placeholder="Contoh: FIL-001" required
                    ...
                    <div>
                        ...
                        <input type="text" name="name" placeholder="Contoh: Oil Filter D85" required
                               class="block w-full rounded-xl border-0 bg-white/50 ring-1 ring-slate-200 focus:ring-2 focus:ring-indigo-500/50 text-slate-700 py-3.5 px-4 transition-all duration-300 outline-none shadow-sm placeholder:text-slate-300 hover:bg-white">
                    </div>
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-[10px] text-slate-400 mt-1.5 ml-1">Biarkan 0 jika kosong.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="min_stock" value="5" required
                               class="block w-full rounded-xl border-0 bg-white/50 ring-1 ring-slate-200 focus:ring-2 focus:ring-indigo-500/50 text-slate-700 py-3.5 px-4 transition-all duration-300 outline-none shadow-sm hover:bg-white">
                        <p class="text-[10px] text-slate-400 mt-1.5 ml-1">Batas peringatan stok menipis.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="unit" value="Pcs" placeholder="Pcs/Set/Box"
                               class="block w-full rounded-xl border-0 bg-white/50 ring-1 ring-slate-200 focus:ring-2 focus:ring-indigo-500/50 text-slate-700 py-3.5 px-4 transition-all duration-300 outline-none shadow-sm hover:bg-white">
                    </div>
                </div>
                ...
                <div class="mt-6">
                    ...
                    <div class="relative group">
                        ...
                        <input type="text" name="location" placeholder="Contoh: Rak A-1, Bin 3"
